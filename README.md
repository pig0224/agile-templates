...
[![Check](https://github.com/fcc-agile/agile-templates/actions/workflows/check.yml/badge.svg)](https://github.com/fcc-agile/agile-templates/actions/workflows/check.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)

[agile CLI](https://github.com/fcc-agile/agile-cli) 的**项目模板源**：`registry.yaml` 声明全部模板。**新增模板无需升级 CLI** —— 新建目录 + 登记 registry.yaml 即可。以 git 仓库分发，推送即发版，无需 npm、无需构建。
